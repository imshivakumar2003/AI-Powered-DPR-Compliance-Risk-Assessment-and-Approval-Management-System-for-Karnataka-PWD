...
export default function UserAiChatbotPage() {
    ...
    return (
      <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ color: 'var(--text-muted)', fontSize: 13 }}>Loading DPR AI Chatbot...</div>
        </div>
      </div>
    );
  }

  return <AiChatbotView moduleType="user" title="DPR AI Chatbot Assistant" />;
}
